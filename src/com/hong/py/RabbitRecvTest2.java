 ...
 **/
public class RabbitRecvTest2 {

    private final static String QUEUE_NAME3 = "test_exchange_03";

    private final static String QUEUE_NAME5 = "test_exchange_05";
    ...
    private static void recvTopicExchange() throws IOException, TimeoutException {
        ...
        //绑定队列到交换机
        channel.queueBind(QUEUE_NAME5,EXCHANGE_NAME3,"anhui.*");
    ...
    private static void recvRetyTopicExchange() throws IOException, TimeoutException {
        // 获取到连接以及mq通道
        Connection connection = RabbitMQUtil.getConnection();
        // 从连接中创建通道
        Channel channel = connection.createChannel();
        ...
        channel.basicConsume(QUEUE_NAME7, true, consumer);
